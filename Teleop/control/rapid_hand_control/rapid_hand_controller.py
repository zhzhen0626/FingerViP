...
class RapidHandController:
    ...
    def __init__(
        ...
        use_fingertip_camera: bool = False,
        ...
        self._hand = RapidNode(
            ...
            use_fingertip_camera=use_fingertip_camera,
            use_third_view_camera=use_third_view_camera,
            third_view_serial_number=third_view_serial_number,
        )
